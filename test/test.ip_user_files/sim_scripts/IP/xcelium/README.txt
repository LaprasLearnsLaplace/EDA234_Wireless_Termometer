...
#
# Generated by export_simulation on Mon Dec 09 18:11:11 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './FIFO_8to8.sh' script.

./FIFO_8to8.sh -reset_run
...
./FIFO_8to8.sh -noclean_files

For more information on the script, please type './FIFO_8to8.sh -help'.
