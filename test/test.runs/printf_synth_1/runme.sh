...
HD_PWD='C:/Users/A/Desktop/EDA234/test/test.runs/printf_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log printf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source printf.tcl
